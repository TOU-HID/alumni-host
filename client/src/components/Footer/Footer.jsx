...
function Footer() {
	return (
		<div>
			<footer className="footer p-10 bg-secondary text-blue-100">
				<div>
			...
			<footer className="footer px-10 py-4 border-t bg-primary text-blue-100 border-base-300">
				<div className="items-center grid-flow-col">
					<img className='w-10 h-10 m-2 rounded-full' src={logo} alt='logo' />
					<p>BUSELL <br />Providing reliable solution since 1992</p>
				</div>
